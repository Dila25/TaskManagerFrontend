...
export default function UpdateAccount() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Only append picture if it's a File object (new upload)
                  ...
                  <div className="relative group ">
                    <div className="w-25 h-25 rounded-full bg-gray-200 overflow-hidden flex items-center justify-center">
                      {preview ? (
                        ...
                        // eslint-disable-next-line @next/next/no-img-element
                        <img src={`https://task-manager-pied-sigma-54.vercel.app/uploads/${formData.picture}`} alt="Current" className="w-full h-full object-cover" />
                      ) : (
                        <svg
              ...
              <div>
                ...
                <div className="mt-1">
                  <input
                    ...
                    autoComplete="email"
                    required
                    className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 sm:text-sm bg-gray-100 cursor-not-allowed"
